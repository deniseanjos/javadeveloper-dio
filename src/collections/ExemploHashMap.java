...
public class ExemploHashMap {
	...
	public static void main(String[] args) {
        ...
        // Adiciona os campeões mundias fifa no mapa onde o nome é a chave
        ...
        // Retorna se existe ou não um campeão de acordo com a chave
        System.out.println(campeoesMundialFifa.containsKey("França"));

        // Remove o campeão informado
        campeoesMundialFifa.remove("França");

        // Retorna se existe ou não o campeão que retiramos acima - informado a key
        System.out.println(campeoesMundialFifa.containsKey("França"));

        // Retorna se existe ou não alguma seleção hexa campeã - retorna true ou false
